...
var idApi = getUrl(config.apiUrl || 'api.1clickanalytics.ru/v1/identify');
 ...
 * Build: `lodash -d -o src/lodash.js exports="commonjs" include="isObject,isUndefined,isNull,isFunction,isArray,extend,isString,once,contains,findLast,chain,pick,map,flatten,value"`
